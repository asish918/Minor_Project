    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            ...
            <div className='grid grid-cols-1 gap-4 mb-4'>
                <textarea ref={commentEl} cols="30" rows="10"
            ...
            <div className='mt-8'>
                <button
                    ...
                    className='transition duration-500 ease hover:bg-indigo-500 inline-block bg-[#9b39b3] text-lg rounded-full text-white px-8 py-3 cursor-pointer'
                >
                    Post Comment
                </button>
